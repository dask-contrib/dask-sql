...
use datafusion_expr::{logical_plan::Distinct, Expr, LogicalPlan};

use crate::sql::exceptions::py_type_err;
use pyo3::prelude::*;

#[pyclass(name = "Distinct", module = "dask_planner", subclass)]
#[derive(Clone)]
...
impl TryFrom<LogicalPlan> for PyDistinct {
    type Error = PyErr;

    fn try_from(logical_plan: LogicalPlan) -> Result<Self, Self::Error> {
        match logical_plan {
            LogicalPlan::Distinct(distinct) => Ok(PyDistinct { distinct }),
