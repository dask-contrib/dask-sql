...
* **GPU Support**: `dask-sql` supports running SQL queries on CUDA/GPU enabled harware by utilizing [RAPIDS](https://rapids.ai) libraries like `dask-cuDF`, enabling accelerated compute for SQL.
